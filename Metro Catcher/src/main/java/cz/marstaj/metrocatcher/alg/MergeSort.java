...
public class MergeSort {
     ...
     */
    public static void mergeSort(double[] array, double[] aux, int left,
                                 int right) {
        if (left == right)
            return;
    ...
    public static void mergeSort(double[] array) {
        mergeSort(array, new double[array.length], 0, array.length - 1);
    }
     ...
     */
    private static void merge(double[] array, double[] aux, int left, int right) {
        int middleIndex = (left + right) / 2;
        int leftIndex = left;
